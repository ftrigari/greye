...
import (
	model "clusterMonitor/internal/application/domain/models"
...
func (hdl *ApplicationHdl) AddApplication(ctx *fiber.Ctx) error {

	response := &model.EasyResponse{
		Message: "Application added to monitoring successfully",
	}

	var requestBody model.RequestInfo
	...
	application := model.NewSchedulerApplication(requestBody)
