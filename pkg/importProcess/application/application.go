...
import (
	"clusterMonitor/pkg/importProcess/domain/ports"
	"flag"
...
func (app *ImportProcessApplication) GetKubernetesMonitoringObject() watch.Interface {

	svcWatch, err := app.clientSet.CoreV1().Services("").Watch(context.TODO(), metav1.ListOptions{})
